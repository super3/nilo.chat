...
git checkout -b main
git add .
git commit -m "Force deploy with timestamp $TIMESTAMP"
...
cd -
echo "Force deployment complete! Check your site in a few minutes."
echo "If you still see old content, try clearing your browser cache or using incognito mode." 